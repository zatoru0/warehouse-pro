...
export const DEPARTMENT_DESCRIPTIONS: Record<Department, string> = {
  ...
  QC:          "ตรวจสอบคุณภาพ, ตัดสินผ่าน/ไม่ผ่าน, ตีตรา/Certify",
...
export const DEPARTMENT_COLORS: Record<Department, string> = {
  ...
  QC:          "bg-violet-500/10 text-violet-700 border-violet-500/30",
...
export const ALL_DEPARTMENTS: Department[] = [
  "INBOUND", "PRODUCTION", "QC", "ADMIN_DEPT", "AFTER_SALES", "WAREHOUSE",
];
