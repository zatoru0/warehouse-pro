...
export default function NewCreditNotePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    if (!reason.trim()) { setError("ระบุเหตุผลการออกใบลดหนี้"); return; }
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-4">
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-lg font-semibold">ออกใบลดหนี้</h2>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-1.5">
              ...
              <Input value={reason} onChange={(e) => setReason(e.target.value)} placeholder="เช่น สินค้าชำรุด, คืนเงินบางส่วน…" required />
            </div>
          </CardContent>
        </Card>
